...
function removeItem(a){var b=a.parentNode.parentNode,c=b.cells[1].innerHTML,d=b.cells[2].innerHTML,f=parseInt(b.cells[3].innerHTML),b=albums.findIndex(function(a,b,g){if(a.title===c&&a.band===d&&a.year===f)return!0});-1!==b?(albums.splice(b,1),$(a).parent().parent().remove()):addErrorBox("Internal error: cannot find album!")}
...
Array.prototype.findIndex||Object.defineProperty(Array.prototype,"findIndex",{value:function(a,b){if(null==this)throw new TypeError("Array.prototype.findIndex called on null or undefined");if("function"!==typeof a)throw new TypeError("predicate must be a function");for(var c=Object(this),d=c.length>>>0,f,e=0;e<d;e++)if(f=c[e],a.call(b,f,e,c))return e;return-1},enumerable:!1,configurable:!1,writable:!1});
